...
public class GeneticAlgorithm {
    ...
    private static final double UNIFORM_RATIO = 0.50;
    private static final double MUT_PROB = 0.05;
    ...
    public static void main(String[] args) {
        ...
        for (int j = 0; j < numIterations; j++) {
            ...
            while (pop.getBestInv().getFitness() != 0 && i != 10000) {
    ...
    public static Population evolvePop(Population pop, GeneticOperator operator, int t) {
        ...
        Population offspring2 = operator.uniformCrossover(offspring, UNIFORM_RATIO);
        Population offspring3 = operator.bitWiseMutation(offspring2, MUT_PROB);
